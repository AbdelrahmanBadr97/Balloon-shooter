...
;it return bl=5 for powerup3 ballon 
...
jz Powerup2_2
cmp ah,0Ch                 ;yellow ballon (double points)
jz Powerup4_2
...
sendname proc
    ...
    mov bx,0 
         ...
         In al , dx 			;Read Line Status
  		 ...
  		 JZ AGAIN1   
         mov dx , 3F8H
         mov al,nam2[bx]	; Transmit data register
         out dx ,al
         inc bx
         cmp bx,15d
         jnz lop 
